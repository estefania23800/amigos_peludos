...
<body>
    <header>
        <div class="bg-image container-header" style="background-image: url('../View/img/hero4.webp');">
            ...
            <div class="Text-Hero p-5 d-flex align-items-end fw-bold">
                <h1>Abiertos y siempre dispuestos a escucharte.
                    ¡Te esperamos!
                </h1>
            </div>
        </div>
    ...
    <main>
        <div class="contactanos-main text-center fs-1 p-4">
            <h1 class="fw-bold">Contáctanos: Haz Parte de Nuestra Misión</h1>
            <div class="">
                <p class="fs-4 mt-4 text-start">Estamos emocionados de saber de ti y de compartir información sobre cómo
                    puedes unirte a nuestra causa. Ya sea que desees adoptar, colaborar como voluntario o simplemente
                    tienes preguntas sobre nuestra labor, ¡nos encantaría escucharte!
                    <br><br>
                    Si estás interesado en adoptar a uno de nuestros amigos peludos, participar como voluntario en
                    nuestras actividades o simplemente quieres saber más sobre cómo puedes apoyarnos, ¡no dudes en
                    contactarnos!
                    <br><br>
                    Además, síguenos en nuestras redes sociales para mantenerte al día con nuestras últimas noticias,
                    eventos y adorables historias de adopción. Estamos ansiosos por conectar contigo y trabajar juntos
                    para hacer del mundo un lugar mejor para nuestros amigos peludos.
                    ¡Gracias por considerar unirte a nuestra misión de darles a cada perro y gato la oportunidad de
                    encontrar un hogar lleno de amor y cuidados!
                </p>
            </div>
        </div>
        <div class="contactanos-formulario">
            <form>
                <div class="contactanos-formulario-NomTel d-flex justify-content-evenly">
                    <div class="mb-3 mt-3">
                        <label class="form-label">Nombre*</label>
                        <input type="email" class="form-control" aria-describedby="Nombre">
                    </div>
                    <div class="mb-3 mt-3">
                        <label class="form-label">Teléfono*</label>
                        <input type="email" class="form-control" aria-describedby="Teléfono">
                    </div>
                </div>
                <div class="contactanos-formulario-Correo d-flex align-items-center justify-content-center  ">
                    <div class="mb-3 mt-3">
                ...
                <div class="contactanos-formulario-Submit ms-5">
                    <button type="submit" class="btn ms-5 mb-5">Enviar</button>
                </div>
