...
<body>
    ...
    <body>
        <header>
            <div class="bg-image container-header" style="background-image: url('../View/img/hero9.webp')">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active fw-bold mx-2" aria-current="pagina Peludos" href="../Controller/Peludos.php">Peludos</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link active fw-bold mx-2" aria-current="pagina Conócenos" href="../Controller/Conocenos.php">Conócenos</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link active fw-bold mx-2" aria-current="pagina Contáctanos" href="../Controller/Contactanos.php">Contáctanos</a>
                                        </li>
                                        <?php
                ...
                <div class="Text-Hero p-5 d-flex align-items-end fw-bold">
                    <h1>¿Necesitas ayuda? <br>Aquí tienes las preguntas más frecuentes</h1>
                </div>
            </div>
        </header>
        <main>
            <div class="ayuda-main">
                <div class="ayuda-main-p">
                    <h1>Preguntas Frecuentes</h1><br>
                    <section id="registro">
                        <h2>Registro de Usuario</h2>
                        <p>Para empezar a utilizar Amigos Peludos, primero debes registrarte como usuario.</p>
                        <p>Para registrarte, sigue estos pasos:</p>
                        <ol>
                            <li>Dirígete hacia el boton superior derecho, Regístrate</li>
                    ...
                    <section id="adopcion">
                        ...
                        <p>El proceso de adopción es sencillo:</p>
                        <ol>
                            <li>Explora la página de <a href="../Controller/Peludos.php">Mascotas</a> para ver las mascotas disponibles.</li>
                            <li>Selecciona la mascota que te interesa.</li>
                            <li>Haz clic en "Adoptar" y sigue las instrucciones.</li>
                        </ol>
                    </section>
                    <section id="mascotas">
                        <h2>Mis Mascotas</h2>
                        <p>En la página de <a href="../Controller/MisMascotas.php">Mascotas</a>, puedes ver en una lista tus mascotas. Cuando estés logeado.</p>
                    </section>
                </div>
                <img src="../View/img/img-ayuda.webp" class="p-3">
            </div>
        </main>
        <footer>
            <div class="footer">
