...
<body>
    ...
    <body>
        <header>
            <div class="bg-image container-header" style="background-image: url('../View/img/hero1.webp')">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active fw-bold mx-2" aria-current="pagina Ayuda" href="../Controller/Ayuda.php">Ayuda</a>
                                        </li>
                                        <?php
                                        if (isset($_SESSION['session'])) {
                                        ?>
                ...
                <div class="Text-Hero p-5 d-flex align-items-end fw-bold">
                    <h1>Ayudamos a nuestros peludos a encontrar a su familia. <br>¿Quieres ser tú?</h1>
                </div>
            </div>
        </header>
        <main>
            <div class="card-group">
                <div class="card">
                    <div class="card-body text-center fw-bold p-4">
                        <p class="card-text1 d-flex justify-content-center fs-2" style="color: #062c80">Nuestra Visión:
                            Hogares <br>Plenos de Amor para<br> Todos</p>
                        <button type="button" class="btn btn-primary mx-2 btn-lg">Conócenos</button>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body text-center fs-5 fw-medium mt-2">
                        <p class="card-text1" style="color: #062c80">En Amigos Peludos, aspiramos a crear un mundo donde
                            cada amigo peludo encuentre un hogar lleno de amor y cuidado. Nos esforzamos por fomentar
                            adopciones responsables y construir una comunidad comprometida con el bienestar de los animales.
                            Nuestra visión es simple pero profunda: queremos ser el puente que une a amigos peludos con
                            hogares felices, forjando conexiones que transformen vidas y creen historias de lealtad
                            inquebrantable. </p>
                    </div>
                </div>
            </div>
            <div class="tabla">
                <table class="table mt-4">
                    <h3 class="text-center"><br>Últimas Adopciones</h3>
                    <tbody>
                        <?php
                        $count = 0;
                        $tdCount = 0;
                                    ...
                                    ?>
                                        <td class="tdL">
                                            <div class="me-5">
                                                ...
                                                <p>Nombre <b><?= $animal->getNombre() ?></b><br>
                                                    Edad <b><?= $animal->getEdad(), ' ', $animal->getTiempo() ?></b><br>
                                                    Sexo <b><?= $animal->getSexo() ?></b><br>
                                                    Tipo <b><?= $animal->getTipo() ?></b><br>
                                                    Estado <b><?= $animal->getEstado() ?></b><br>
                                                    Localización <b><?= $animal->getLocalizacion() ?></b><br>
                                                    Tamaño <b><?= $animal->getTamaño() ?></b><br>
                                                    Protectora <b><?= $animal->getProtectora() ?></b><br>
                                                </p>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="table-imgL mt-3 ms-5" style="background-image: url('<?= $animal->getImagen() ?>');"></div>
                                        </td>
                                    <?php } else { ?>
                                        <td>
                                            <div class="table-img mt-3 me-5" style="background-image: url('<?= $animal->getImagen() ?>');"></div>
                                        </td>
                                        <td>
                                            <div class="ms-5">
                                                <h3><?= $animal->getNombre() ?></h3>
