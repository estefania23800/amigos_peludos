...
<body>
    <header>
        <div class="bg-image container-header" style="background-image: url('../View/img/hero7.webp');">
    ...
    <main>
        <div class="tablaP w-100">
            ...
            <table class="table mt-4 w-75 m-auto text-center mb-5">
                ...
                <tbody>
                    <?php
                    foreach ($data['arrayBidimensional'] as $item) {
                        $animal = $item['animal'];
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    ...
                                    <form id="formularioOculto" action="AceptarSolicitud.php" method="post">
                                        <!-- Datos ocultos -->
                                        ...
                                        <input type="hidden" name="Localización" value="<?= $usuario->getLocalidad() ?>">
                                    ...
                                    <form id="formularioOculto" action="RechazarSolicitud.php" method="post">
                                        <!-- Datos ocultos -->
                                        <input type="hidden" name="ID" value="<?= $animal->getIdAnimal() ?>">
                                        <input type="hidden" name="Nombre" value="<?= $animal->getNombre() ?>">
                                        <input type="hidden" name="Edad" value="<?= $animal->getEdad() ?>">
