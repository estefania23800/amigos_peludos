...
<body>
    <header>
        <div class="bg-image container-header" style="background-image: url('../View/img/hero6.webp');">
                        ...
                        <tr class="mt-1">
                            ...
                            <td>
                                <div class="ms-5">
                                    ...
                                    <div>Nombre <b><?= $animal->getNombre() ?></b></div>
                                    <div>Edad <b><?= $animal->getEdad() ?></b></div>
                                    <div>Sexo <b><?= $animal->getSexo() ?></b></div>
                                    <div>Tipo <b><?= $animal->getTipo() ?></b></div>
                                    <div>Estado <b><?= $animal->getEstado() ?></b></div>
                                    <div>Localización <b><?= $animal->getLocalizacion() ?></b></div>
                                    <div>Tamaño <b><?= $animal->getTamaño() ?></b></div>
                                    <div>Protectora <b><?= $animal->getProtectora() ?></b></div>
                                    <button>Solicitado</button>
                                </div>
                            </td>
                        </tr>
                    <?php
