...
<body>
    <header>
        <div class="bg-image container-header" style="background-image: url('../View/img/hero3.webp');">
    ...
    <main>
        <div class="conocenos-main-h1 text-center fs-1 p-4">
            <h1>Descubre Nuestra Pasión por los Peludos</h1>
        <div class="conocenos-main">
            <div class="conocenos-main-p">
                <p class="fs-4 mt-4 text-start">En nuestra comunidad, somos una red dedicada de asociaciones de animales unidas por un
                    objetivo común:
                    encontrar hogares amorosos para cada perro y gato que cruza nuestro camino. Nos comprometemos a trabajar
                    juntos, compartiendo conocimientos, recursos y pasión para garantizar que ningún amigo peludo se quede
                    sin un lugar al que llamar hogar.
                    <br><br>
                    Como una asociación de asociaciones, nos enorgullecemos de nuestra colaboración estrecha y compromiso
                    colectivo con la causa de la adopción. Unimos fuerzas para educar, difundir conciencia y promover la
                    adopción responsable de perros y gatos, brindándoles una segunda oportunidad y un futuro lleno de
                    cariño.
                    <br><br>
                    Nuestro enfoque multifacético abarca desde campañas educativas hasta eventos de adopción, pasando por
                    programas de cuidado y rehabilitación. Trabajamos incansablemente para enseñar a todos, desde familias
                    hasta individuos, la alegría y la gratitud que trae consigo darle a un amigo peludo un hogar para
                    siempre.
                    <br><br>
                    Únete a nosotros en este viaje compartido hacia un mundo donde cada ladrido y ronroneo sean señales de
                    un hogar encontrado. Te invitamos a explorar nuestros esfuerzos colectivos, aprender sobre nuestras
                    asociaciones miembro y ser parte de nuestra misión de transformar vidas a través de la adopción.
                </p>
            </div>
            <img src="../View/img/img-conocenos.webp">
        </div>
    </div>
    </main>
    <footer>
